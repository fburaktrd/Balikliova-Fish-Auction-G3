                ...
                Container(
                  ...
                  child: TextButton(
                    ...
                    onPressed: () {
                      if(!wasSecondRound){
                        Flushbar(
                            title: "Second round is not started yet",
                            message:
                            "You can only change prices in the second round.",
                            duration: const Duration(
                                seconds: 3))
                            .show(context);
                      } else{
